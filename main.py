...
FAVICON = "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='20' fill='#6d28d9'/><text x='50' y='68' font-size='52' font-weight='bold' fill='white' text-anchor='middle' font-family='Arial'>SF</text></svg>"
    ...
    <head>
        ...
        <style>
            * {{ word-wrap: break-word; overflow-wrap: anywhere; }}
            ...
            .dropdown-content {{ display: none; position: absolute; left: 50%; transform: translateX(-50%); background: #1e1b4b; border-radius: 12px; padding: 6px; min-width: 200px; z-index: 200; border: 1px solid rgba(255,255,255,0.15); bottom: 100%; margin-bottom: 8px; max-height: 250px; overflow-y: auto; }}
            ...
            .logo-img {{ height: 56px; border-radius: 14px; margin-bottom: 10px; display: block; margin-left: auto; margin-right: auto; }}
            ...
            <div id="preview-container">
                <div class="flex justify-between items-center mb-3 flex-wrap gap-2">
                    ...
                    <div class="flex gap-1 flex-wrap items-center">
                        <button onclick="downloadHTML()" class="text-xs bg-gray-700 hover:bg-gray-600 text-white px-3 py-1.5 rounded-lg transition">💾 Скачать HTML</button>
    ...
    <body class="bg-gray-950 text-white min-h-screen">
        <div class="max-w-2xl w-full px-4 mx-auto py-6">
            ...
            <div class="bg-gray-900 rounded-2xl p-8 border border-gray-800 mt-4 relative">
                <div id="plo"><p class="text-center text-gray-400">Войдите в аккаунт, чтобы увидеть профиль.</p></div>
        ...
        <script>
            ...
            if (u) {{
                ...
                if (u.email === 'dimkavihrov@gmail.com') {{
                    fetch('/stats').then(r => r.json()).then(d => {{
                        document.getElementById('stats-line').textContent = '👥 Всего: ' + d.total_users + ' | За 24ч: ' + d.today_users;
                    }});
                }}
            }}
